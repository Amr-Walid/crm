...
namespace UniGroup.CRM.Infrastructure.Migrations
{
    ...
    [Migration("20260719102357_AddMainCategoryToTickets")]
    partial class AddMainCategoryToTickets
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UniGroup.CRM.Domain.Entities.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("ClientInfo", "UniGroup.CRM.Domain.Entities.AuditLog.ClientInfo#ClientInfo", b1 =>
                        {
                            b1.IsRequired();
                            ...
                            b1.Property<string>("IpAddress")
                                .HasMaxLength(100)
                                .HasColumnType("nvarchar(100)")
                                .HasColumnName("ClientInfo_IpAddress");

                            b1.Property<string>("UserAgent")
                                .HasColumnType("nvarchar(max)")
                                .HasColumnName("ClientInfo_UserAgent");
                        });
            ...
            modelBuilder.Entity("UniGroup.CRM.Domain.Entities.CsatSurvey", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CsatSurveys", (string)null);
                });
            ...
            modelBuilder.Entity("UniGroup.CRM.Domain.Entities.KnowledgeBaseArticle", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("UniGroup.CRM.Domain.Entities.NotificationLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("UniGroup.CRM.Domain.Entities.ProcessedWebhookEvent", b =>
                {
